...
"[project]/src/app/pets/[id]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PetPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        fetch(`${API_BASE_URL}/api/pets/${id}`).then((res)=>{
            if (!res.ok) throw new Error('Failed to fetch pet');
            return res.json();
        }).then((data)=>setPet(data)).catch((error)=>console.error('Error fetching pet:', error));
    }, [
        id
    ]);
...
//# sourceMappingURL=src_app_pets_%5Bid%5D_page_tsx_7d9c597a._.js.map